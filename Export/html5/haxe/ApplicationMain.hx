...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MemoryGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MemoryGame", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MemoryGame";
		app.meta["name"] = "MemoryGame";
		app.meta["packageName"] = "org.openfl.samples.memorygame";
